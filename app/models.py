...
class Booking(models.Model):
    ...
    first_name = models.CharField('姓', max_length=50, null=True, blank=True)
    last_name = models.CharField('名', max_length=50, null=True, blank=True)
    tel = models.CharField('電話番号', max_length=50, null=True, blank=True)
    ...
    def __str__(self):
        ...
        end = timezone.localtime(self.start).strftime('%Y/%m/%d %H:%M')
